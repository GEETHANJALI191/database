...
--
-- Definition of table `campusminds1`
--

DROP TABLE IF EXISTS `campusminds1`;
CREATE TABLE `campusminds1` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `campusminds1`
--

/*!40000 ALTER TABLE `campusminds1` DISABLE KEYS */;
INSERT INTO `campusminds1` (`id`,`name`) VALUES 
 (121,'jeev'),
 (122,'geethanjali');
/*!40000 ALTER TABLE `campusminds1` ENABLE KEYS */;
...
--
-- Create schema dbase1
--

CREATE DATABASE IF NOT EXISTS dbase1;
USE dbase1;
...
CREATE TABLE `campusminds` (
  ...
  `mindsname` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `campusminds` (`userid`,`mindsname`) VALUES 
 (4,'kanu'),
 (5,'geethu'),
 (6,'geethanjali'),
 (7,'divya'),
...
--
-- Definition of table `minds1`
--

DROP TABLE IF EXISTS `minds1`;
CREATE TABLE `minds1` (
...
--
-- Dumping data for table `minds1`
--

/*!40000 ALTER TABLE `minds1` DISABLE KEYS */;
/*!40000 ALTER TABLE `minds1` ENABLE KEYS */;


--
-- Definition of table `pojo23`
--

DROP TABLE IF EXISTS `pojo23`;
CREATE TABLE `pojo23` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `pojo23`
--

/*!40000 ALTER TABLE `pojo23` DISABLE KEYS */;
INSERT INTO `pojo23` (`id`,`name`) VALUES 
 (1,'mallesh'),
 (2,'girija'),
 (3,'kanusha'),
 (122,'suhas');
/*!40000 ALTER TABLE `pojo23` ENABLE KEYS */;
...
CREATE DATABASE IF NOT EXISTS geetha;
USE geetha;
...
--
-- Definition of table `campus_minds`
--

DROP TABLE IF EXISTS `campus_minds`;
CREATE TABLE `campus_minds` (
  `campusmind_mid` int(11) NOT NULL,
  `campusmind_name` varchar(30) DEFAULT NULL,
  `campusmind_trackid` int(11) DEFAULT NULL,
  `mid` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `trackid` int(11) NOT NULL,
  `lead_trackid` int(11) DEFAULT NULL,
  PRIMARY KEY (`campusmind_mid`),
  KEY `FK333CB701806C9B42` (`lead_trackid`),
  CONSTRAINT `FK333CB701806C9B42` FOREIGN KEY (`lead_trackid`) REFERENCES `leads` (`lead_mid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `campus_minds`
--

/*!40000 ALTER TABLE `campus_minds` DISABLE KEYS */;
/*!40000 ALTER TABLE `campus_minds` ENABLE KEYS */;


--
-- Definition of table `campus_minds1`
--

DROP TABLE IF EXISTS `campus_minds1`;
CREATE TABLE `campus_minds1` (
  `campusmind_mid` int(11) NOT NULL AUTO_INCREMENT,
  `campusmind_name` varchar(30) DEFAULT NULL,
  `campusmind_trackid` int(11) DEFAULT NULL,
  `lead_trackid` int(11) DEFAULT NULL,
  `lead_mid` int(11) DEFAULT NULL,
  PRIMARY KEY (`campusmind_mid`),
  KEY `FK345A2950806C9B42` (`lead_trackid`),
  KEY `FK345A295018C90064` (`lead_mid`),
  CONSTRAINT `FK345A295018C90064` FOREIGN KEY (`lead_mid`) REFERENCES `leads1` (`lead_mid`),
  CONSTRAINT `FK345A2950806C9B42` FOREIGN KEY (`lead_trackid`) REFERENCES `leads1` (`lead_mid`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `campus_minds1`
--

/*!40000 ALTER TABLE `campus_minds1` DISABLE KEYS */;
INSERT INTO `campus_minds1` (`campusmind_mid`,`campusmind_name`,`campusmind_trackid`,`lead_trackid`,`lead_mid`) VALUES 
 (1,'geetha',1,123,NULL),
 (2,'jeev',3,34,NULL),
 (3,'erf',5,NULL,45),
 (4,'rty',3,NULL,99);
/*!40000 ALTER TABLE `campus_minds1` ENABLE KEYS */;
...
CREATE TABLE `leads` (
  `lead_mid` int(11) NOT NULL,
  `lead_trackid` int(11) DEFAULT NULL,
  `lead_name` varchar(30) DEFAULT NULL,
  `lmid` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `trackid` int(11) NOT NULL,
  `orchard_trackid` int(11) DEFAULT NULL,
  PRIMARY KEY (`lead_mid`),
  KEY `FK45E5C77BB49F042` (`orchard_trackid`),
  CONSTRAINT `FK45E5C77BB49F042` FOREIGN KEY (`orchard_trackid`) REFERENCES `orchard` (`orchard_trackid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Definition of table `leads1`
--

DROP TABLE IF EXISTS `leads1`;
CREATE TABLE `leads1` (
  `lead_mid` int(11) NOT NULL AUTO_INCREMENT,
  `lead_trackid` int(11) DEFAULT NULL,
  `lead_name` varchar(30) DEFAULT NULL,
  `orchard_trackid` int(11) DEFAULT NULL,
  PRIMARY KEY (`lead_mid`),
  KEY `FK876D329ABB49F042` (`orchard_trackid`),
  CONSTRAINT `FK876D329ABB49F042` FOREIGN KEY (`orchard_trackid`) REFERENCES `orchard` (`orchard_trackid`)
) ENGINE=InnoDB AUTO_INCREMENT=124 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `leads1`
--

/*!40000 ALTER TABLE `leads1` DISABLE KEYS */;
INSERT INTO `leads1` (`lead_mid`,`lead_trackid`,`lead_name`,`orchard_trackid`) VALUES 
 (34,3,'suhas',3),
 (45,5,'hdg',5),
 (99,1,'evvr',8),
 (123,1,'jay',1);
/*!40000 ALTER TABLE `leads1` ENABLE KEYS */;
...
CREATE TABLE `orchard` (
  `orchard_trackid` int(11) NOT NULL,
  `orchard_trackname` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`orchard_trackid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `orchard` (`orchard_trackid`,`orchard_trackname`) VALUES 
 (1,'java'),
 (3,'sap'),
 (5,'java'),
 (8,'kij');
...
/*!40000 ALTER TABLE `campus_minds` DISABLE KEYS */;
INSERT INTO `campus_minds` (`Mid`,`Name`,`Track`) VALUES 
 (31,'geethanjali','EAI');
/*!40000 ALTER TABLE `campus_minds` ENABLE KEYS */;


--
-- Definition of table `team_lead`
--
...
INSERT INTO `team_lead` (`Mid`,`Name`,`Track`) VALUES 
 (21,'monika','JAVA');
/*!40000 ALTER TABLE `team_lead` ENABLE KEYS */;

--
-- Create schema orcharddb1
--

CREATE DATABASE IF NOT EXISTS orcharddb1;
USE orcharddb1;
...
CREATE TABLE `campus_minds` (
  ...
  `mindname` varchar(255) DEFAULT NULL,
  `track` varchar(255) DEFAULT NULL,
  `tl_Mid` int(11) DEFAULT NULL,
  PRIMARY KEY (`Mid`),
  KEY `FK333CB7011EB47F34` (`tl_Mid`),
  CONSTRAINT `FK333CB7011EB47F34` FOREIGN KEY (`tl_Mid`) REFERENCES `team_lead` (`Mid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
/*!40000 ALTER TABLE `campus_minds` DISABLE KEYS */;
INSERT INTO `campus_minds` (`Mid`,`leadname`,`mindname`,`track`,`tl_Mid`) VALUES 
 (21,'jay','geetha','JAVA',31),
 (31,'monika','geethanjali','EAI',21);
/*!40000 ALTER TABLE `campus_minds` ENABLE KEYS */;
...
--
-- Create schema orchardspring
--

CREATE DATABASE IF NOT EXISTS orchardspring;
USE orchardspring;

--
-- Definition of table `orchards`
--
...
INSERT INTO `employees` (`id`,`age`,`name`,`salary`) VALUES 
 (1,23,'geetanjali',300000),
 (2,25,'jeevitha',350000);
/*!40000 ALTER TABLE `employees` ENABLE KEYS */;
...
INSERT INTO `employee` (`id`,`age`,`name`) VALUES 
 (4,24,'John'),
 (6,24,'John');
